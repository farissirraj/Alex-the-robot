...
#define ALEX_KEY_FNAME "alex.key"
#define CA_CERT_FNAME  "signing.pem"
#define ALEX_CERT "alex.crt"
#define LAPTOP_NAME "Taewon"
#define CA_CERT_NAME "Faris"
/* END TODO */
...
int main()
{
    ...
    createServer(ALEX_KEY_FNAME, ALEX_CERT, SERVER_PORT,&worker, CA_CERT_FNAME, LAPTOP_NAME,1);
